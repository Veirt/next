      ...
      roundData: [
        {
          ...
          Keystrokes: {
            averageDelay: 103,
            delay: [
              0, 296, 649, 52, 213, 203, 184, 168, 53, 87, 105, 16, 54, 50, 80, 40, 107, 45, 70, 55, 14, 85, 50, 46, 44,
              38, 94, 71, 28, 92, 31, 104, 50, 78, 58, 118, 70, 76, 52, 74, 48, 149, 58, 404, 960, 24, 91, 564, 281,
              235, 151, 5, 85, 29, 85, 332, 137, 126, 144, 133, 84, 99, 63, 193, 196, 65, 30, 95, 110, 50, 45, 78, 39,
              102, 64, 158, 123, 46, 79, 57, 76, 72, 47, 38, 73, 94, 91, 90, 44, 35, 61, 69, 61, 62, 45, 46, 60, 83, 6,
              34, 121, 63, 100, 102, 56, 26, 87, 54, 22, 88, 67, 81, 92, 125, 9, 162, 43, 106, 64, 56, 66, 43, 154, 50,
              121, 45, 60, 91, 71, 148, 6, 273, 26, 107, 67, 154, 56, 108, 40, 99, 46, 26, 54, 50, 89, 295, 114, 107,
              104, 101, 51, 114, 62, 475, 40, 68, 140, 62, 124, 56, 110, 68, 52, 36, 42, 81, 85, 45, 66, 56, 50, 83, 64,
              25, 87, 32, 91, 46, 18, 888, 209, 738, 93, 49, 110, 45, 66, 137, 59, 62, 47, 37, 69, 99, 47, 46, 69, 113,
              148, 113, 113, 77, 78, 37, 117, 46, 36, 59, 84, 31, 77, 40, 135, 106, 103, 102, 84, 60, 14, 313, 240, 258,
            ],
          ...
          Words: {
            averageWPM: 522,
            wpm: [
              0, 873, 262, 392, 204, 444, 554, 381, 2559, 355, 1118, 579, 160, 328, 327, 284, 158, 545, 153, 183, 555,
              164, 148, 601, 535, 782, 524, 126, 139, 948, 1143, 296, 111, 278, 210, 2151, 369, 414, 796, 141, 232,
              1415,
            ],
            incorrect: [8, 30, 35],
          },
          ...
          Chart: {
            wpm: [
              16.46, 46.95, 81.79, 92.76, 79.43, 83.61, 87.71, 89.53, 93.51, 99.13, 103.8, 105.84, 109.33, 110.97,
              111.34, 112.47, 114.58, 115.12, 111.33, 113.36, 115.2,
            ],
            labels: [
              'look,',
              'found',
            ...
            words: [
              873, 392, 444, 381, 355, 579, 328, 284, 545, 183, 164, 601, 782, 126, 948, 296, 278, 990, 414, 141, 258,
            ],
            step: 0,
          },
          Text: {
