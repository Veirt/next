...
const Activate = (props: IProps) => {
    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        axios.post(`${Config.authUrl}/activate`, { emailAddress, key: code, _csrf }, { cancelToken: axiosCancelSource.current?.token, withCredentials: true })
            .then((response) => {
                ...
                <div className="w-full sm:w-128 m-auto px-4 md:px-10">
                    <div className="bg-gray-775 rounded-2xl shadow-lg p-5 md:p-8">
                        ...
                        <form method="post" onSubmit={handleSubmit}>
                            ...
                            <div>
                                <button type="submit" className="flex ml-auto button small lightgray">Activate</button>
                            </div>
                        </form>
                    </div>
                </div>
