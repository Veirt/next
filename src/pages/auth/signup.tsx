...
const Login = () => {
    ...
    const FormInput = [
        ...
        { icon: faUser, name: "displayName", type: "text", placeholder: "Display Name", value: displayName, onChange: setDisplayName }
    ]
                        ...
                        <form method="post" onSubmit={handleSubmit}>
                            ...
                            <div className="grid grid-cols-5 gap-y-2">
                                ...
                                <div className="col-span-full xs:col-span-2">
                                    <button type="submit" className="flex mx-auto xs:mr-0 xs:ml-auto button small lightgray">Sign Up</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    <Link to="/auth/login" className="text-lg block mt-4 text-center font-semibold hover:opacity-70 transition ease-in-out duration-300">Already have an account?</Link>
                </div>
            </div>
        </Base>
    )
