...
const config = {
  ...
  webUrl: process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : toggleStaging ? 'https://staging.keymash.io' : 'https://keymash.io',
  ...
  gameServer: process.env.NODE_ENV === 'development' ? { URL: 'http://localhost', Port: 2096 } : { URL: toggleStaging ? 'https://wsstaging.keymash.io' : 'https://us-east.keymash.io', Port: null },
};
