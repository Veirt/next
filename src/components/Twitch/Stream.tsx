    ...
    <div className="h-full">
      <a href={`https://twitch.tv/${props.name}`} target={'_blank'} rel="noreferrer">
        <div className={'bg-gray-775 hover:bg-gray-800 transition ease-in-out duration-200 rounded shadow'}>
          ...
          <div className={'p-4'}>
            <div className={'pb-2 text-white font-semibold tracking-wider w-full truncate'}>{props.title}</div>
            <div className={'flex'}>
              <div className={'w-auto mr-auto'}>
                <div className={'flex text-sm'}>
                  ...
                  <div className={'w-auto pl-2 my-auto'}>
                    <span className={'text-orange-400 tracking-wider'}>{props.name}</span>
                  </div>
                </div>
              </div>
              <div className={'w-auto text-sm text-right text-white'}>
                <div className={'text-right'}>{props.viewers} viewers</div>
              </div>
            </div>
          </div>
        </div>
