...
import {
  ...
  faHourglass,
  faAngleDoubleLeft,
  faAngleDoubleRight, faSpinner, faCoins, faLevelUpAlt, faTasks,
...
import PlayerProgress from './participants/PlayerProgress';
...
const MatchEnd = (props: IProps) => {
    ...
    const { data, matchData, showRewards, tournamentId, leaveUrl, restartUrl, embed, embedOwner, embedClose } = props;
    ...
    const boxCSS = 'p-4 lg:px-8 lg:py-4 text-center bg-gray-825 rounded-2xl shadow-md flex flex-nowrap justify-center sm:justify-start sm:flex-wrap';
                          ...
                          <>
                              <div>
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-8 gap-4">
                                        {/* Level & Ranked */}
                                        <div className={`${boxCSS} col-span-1 lg:col-span-3`}>
