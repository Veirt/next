export default (
  <div className={'container container-content container-margin grid grid-cols-1 gap-8'}>
    <div
      className={'relative hero flex py-6 px-8 bg-gray-900 rounded-xl shadow-lg'}
      style={{ backgroundImage: `url('/assets/about/US.png')`, backgroundSize: 'cover', backgroundPosition: 'center' }}
    >
      <div className={'w-full grid grid-cols-2 gap-16'}>
        <div className={'col-span-full lg:col-span-1 my-auto'}>
          ...
          <p className={'text-white text-base mt-6 p-2 bg-gradient-to-r from-gray-800 to-transparent rounded-lg'}>
            Keymash is an online multiplayer typing game that allows typists from all around the world go against each
            other and find out who comes on top.
          </p>
        </div>
        <div className={'col-span-full lg:col-span-1 my-auto'}>
          <img
            src={'/assets/about/match.png'}
            className={'w-10/12 lg:w-full h-auto block mx-auto transform lg:scale-110'}
            alt={'Match mockup'}
          />
        </div>
      </div>
    ...
    <div className={'content-box'}>
      <div className={'grid grid-cols-3 gap-16'}>
        <div className={'col-span-full lg:col-span-2 my-auto'}>
          ...
          <div
            className={
              'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-3 gap-y-1 font-semibold text-white text-lg'
            }
          >
            <div>heynocnoc</div>
            <div>daangast</div>
    ...
    <div className="content-box">
      <div className={'grid grid-cols-3 gap-16'}>
        <div className={'col-span-full lg:col-span-1 my-auto'}>
          <img
            src={'/assets/about/thumbsup.png'}
            className={'w-64 lg:w-10/12 h-auto block mx-auto'}
            alt={'Thumbs Up'}
          />
        </div>
      ...
      <div className={'text-lg font-semibold mt-10 hidden'}>
        ...
        <div className={'text-white text-base font-normal'}>
          Aery#8535, ai#3734, Al_The_Awesome#0351, Amaranth#0069, Andrea#5347, Bailey#0048, bluely#6758,
          Bomb_Guard#0414, call me napkin#3817, chak#5471, Chriss#3132, Climbing Bird YT#4532, Conspyre#9999,
          craurd#3504, D y l a n#5666, DAN#9019, dancetheorist#5850, Dango#5524, Decone#2516, deroche#8343, dessle#9999,
          dicey#1000, discoRyne#6820, Dog Galindo xd#9031, eiko#5645, Eni#4999, erik aka shazzy#4466, faxlore#0069,
          felix.b#1633, firewaran#0241, Foggy#8530, Fruit#9006, poem#3305, Jisoo#2991, Jonathan#6666, Kathy#8713,
          KeeganT#1689, LaggyLuke#0001, LeSirH#0001, lib#2382, Lord Yhru#0403, Lucky Forrest#2201, luna#1234,
          MysteriousSilver#8509, Doppler#8434, Nova#1281, oats#6148, POLAKSTWO#6606, Pro QBr#7679, Reimi#0383,
          samuraipie#4319, Sean Wrona, Seraph#9999, Shouto#5759, sig#7811, Speed Typing#8829, EvilTexan*A$HL3Y*#0001,
          ssteve#6840, T_0nio#9879, tchke#0001, The Devil#4942, timjeffery44#0004, TyrantTick#1570, valikor#2036,
          Vielle#5703, Volhosis#6085, Voort Fujiwara#7197 and xX0T1Xx#0272
        </div>
      </div>
    </div>
    ...
    <div className="content-box">
      <div className={'text-lg font-semibold'}>
        ...
        <div className={'text-white text-base font-normal'}>
          If you are looking to get a hold of us for general inquiries or are from an educational facility looking to
          use Keymash privately with your students:
        </div>
