            ...
            <div className={"container m-auto"}>
                <div className={"w-full grid grid-cols-3 gap-16"}>
                    ...
                    <div className={"col-span-full lg:col-span-2 my-auto"}>
                        <img src={'/assets/about/match.png'} className={"w-64 lg:w-full h-auto block mx-auto"} alt={"Match mockup"} />
                    </div>
                </div>
            </div>
        ...
        <div className={"h-full bg-gray-775"}>
            <div className={"container"}>
                <div className={"grid grid-cols-3 gap-16 py-24"}>
                    <div className={"col-span-full lg:col-span-1"}>
                        <img src={'/assets/about/staff.png'} className={"w-64 lg:w-full h-auto block mx-auto"} alt={"Staff"} />
                    </div>
                    <div className={"col-span-full lg:col-span-2 my-auto"}>
                ...
                <div className={"grid grid-cols-3 gap-16 py-24 border-t border-gray-700"}>
                    <div className={"col-span-full lg:col-span-2 my-auto lg:pr-32"}>
                        <h2 className={"h1 text-orange-400"}>Patreon Supporters</h2>
                        <p className={"text-lg text-gray-500 font-semibold py-4 w-full lg:w-1/2"}>
                    ...
                    <div className={"col-span-full lg:col-span-1"}>
                        <img src={'/assets/about/heart.png'} className={"w-64 lg:w-full h-auto block mx-auto"} alt={"Heart"} />
                    </div>
                </div>

                <div className={"grid grid-cols-3 gap-16 py-32 border-t border-gray-700"}>
                    <div className={"col-span-full lg:col-span-1"}>
                        <img src={'/assets/about/thumbsup.png'} className={"w-64 lg:w-full h-auto block mx-auto"} alt={"Thumbs Up"} />
                    </div>
                    <div className={"col-span-full lg:col-span-2 my-auto"}>
                        ...
                        <div className={"pt-6 grid grid-cols-1 lg:grid-cols-2 gap-x-10 gap-y-6 font-semibold text-lg"}>
                            ...
                            <div>
                                <div className={"text-gray-400"}>Promoting / Dictionary / Overall G</div>
                                <div className={"text-white"}>Miodec from Monkeytype</div>
                            </div>
                            <div>
                                <div className={"text-gray-400"}>Another Overall G</div>
