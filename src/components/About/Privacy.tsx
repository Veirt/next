export default (
    <div className={"container container-content container-margin grid grid-cols-1 gap-8"}>
        <div className={"relative hero py-16 px-8 bg-gray-900 rounded-xl shadow-lg"} style={{ backgroundImage: `url('/assets/about/PRIVACY.webp')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            <h1 className={"text-2xl sm:text-3xl lg:text-4xl xl:text-5xl uppercase text-orange-400"}>Privacy Policy</h1>
            <p className={"block text-white text-lg pt-6"}>
        ...
        <div className={"content-box"}>
            ...
            <p>
              ...
              regards to the information that they shared and/or collect in Keymash. This policy is not applicable to any
            ...
            <p>
              Keymash follows a standard procedure of using log files. These files log visitors when they visit websites.
            ...
            <p>
              Like any other website, Keymash uses 'cookies'. These cookies are used to store information including
            ...
            <p>
              ...
              to our site visitors based upon their visit to www.Keymash and other sites on the internet. However, visitors
            ...
            <p>
              ...
              in their respective advertisements and links that appear on Keymash, which are sent directly to users'
            ...
            <p>
              Note that Keymash has no access to or control over these cookies that are used by third-party advertisers.
            </p>

            <div className="font-semibold pt-4">Third Party Privacy Policies</div>

            <p>
              Keymash's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            ...
            <p>
              Keymash does not knowingly collect any Personal Identifiable Information from children under the age of 13.
            </p>
