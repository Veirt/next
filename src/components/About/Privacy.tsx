export default (
    <div className={"mt-12 text-center lg:text-left"}>
      <div className={"relative hero flex py-24 xl:pt-24 xl:pb-56 bg-gray-900"} style={{ backgroundImage: `url('/assets/about/PRIVACY.webp'')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div className={"h-full bg-gray-775 text-white py-10"}>
        <div className={"container"}>
          <div>
            ...
            <p>
              At Keyma.sh, accessible from Keyma.sh, one of our main priorities is the privacy of our visitors. This Privacy
              Policy document contains types of information that is collected and recorded by Keyma.sh and how we use it.
            </p>
            ...
            <p>
              ...
              regards to the information that they shared and/or collect in Keyma.sh. This policy is not applicable to any
            ...
            <p>
              Keyma.sh follows a standard procedure of using log files. These files log visitors when they visit websites.
            ...
            <p>
              Like any other website, Keyma.sh uses 'cookies'. These cookies are used to store information including
            ...
            <p>
              ...
              to our site visitors based upon their visit to www.Keyma.sh and other sites on the internet. However, visitors
            ...
            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Keyma.sh.</p>

            <p>
              Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
              in their respective advertisements and links that appear on Keyma.sh, which are sent directly to users'
            ...
            <p>
              Note that Keyma.sh has no access to or control over these cookies that are used by third-party advertisers.
            </p>

            <div className="font-semibold pt-4">Third Party Privacy Policies</div>

            <p>
              Keyma.sh's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            ...
            <p>
              Keyma.sh does not knowingly collect any Personal Identifiable Information from children under the age of 13.
            </p>
