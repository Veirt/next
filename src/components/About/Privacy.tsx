export default (
  <div className={'container container-content container-margin grid grid-cols-1 gap-8'}>
    ...
    <div className={'content-box'}>
      ...
      <p>
        At Keymash, accessible from Keymash, one of our main priorities is the privacy of our visitors. This Privacy
        Policy document contains types of information that is collected and recorded by Keymash and how we use it.
      </p>
      ...
      <p>
        ...
        to the information that they shared and/or collect in Keymash. This policy is not applicable to any information
      ...
      <p>
        Keymash follows a standard procedure of using log files. These files log visitors when they visit websites. All
      ...
      <p>
        Like any other website, Keymash uses 'cookies'. These cookies are used to store information including visitors'
      ...
      <p>
        ...
        our site visitors based upon their visit to www.Keymash and other sites on the internet. However, visitors may
      ...
      <p>
        ...
        in their respective advertisements and links that appear on Keymash, which are sent directly to users' browser.
      ...
      <p>
        Keymash's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
