...
export default (
    <div className={"mt-12 text-center lg:text-left"}>
        <div className={"relative hero flex py-24 xl:pt-24 xl:pb-56 bg-gray-900"} style={{ backgroundImage: `url('/assets/about/FAQ.webp'')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
