    ...
    <div className={"container container-content container-margin grid grid-cols-1 gap-8"}>
        ...
        <div className={"content-box"}>
            ...
            <div className="pb-5">
                ...
                We try to combat this problem by having a version controller that will automatically reset your session but sometimes that also does not work. You can fix this by logging out of your account manually by clicking <a className="text-orange-300 hover:text-orange-400 font-semibold transition ease-in-out duration-300" href={`${Config.oauthUrl}/logout`}>here</a>.
            </div>
