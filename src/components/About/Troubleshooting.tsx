...
export default (
    <div className={"mt-12 text-center lg:text-left"}>
        <div className={"relative hero flex py-24 xl:pt-24 xl:pb-56 bg-gray-900"} style={{ backgroundImage: `url('/assets/about/TROUBLESHOOTING.webp')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                ...
                <div>
                    <p className={"text-white text-lg"}>
                        ...
                        <div>
                            ...
                            logs and can either message Staff on Discord or email us directly at support@keyma.sh
                        </div>
                    </p>
                </div>
            </div>
